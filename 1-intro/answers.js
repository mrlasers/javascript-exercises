...
console.log('Goodnight, Moon.'.startsWith('Hello'))

// # NUMBERS

// print the number 23 to the console using the addition operator and any two numbers
